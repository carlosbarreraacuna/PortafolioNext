            ...
            <div className="flex justify-between h-48">
              ...
              <div className="w-1/3 ">
                ...
                <div className="p-3 text-sm italic text-black">
                  • Lenguajes utilizados (PHP) – Framework (Laravel, Liveware,
                  Codeigneiter 3) • Desarrollo del software SAP (Sistema de
                  atención psicológica) • Manejo de control de versiones Git,
                  Gitlab.{" "}
                </div>
                {/* JOB DATE */}
